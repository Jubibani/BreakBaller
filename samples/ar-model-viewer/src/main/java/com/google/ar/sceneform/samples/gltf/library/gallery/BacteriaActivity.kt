...
class BacteriaActivity : AppCompatActivity(R.layout.activity) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            supportFragmentManager.commit {
                add(R.id.containerFragment, BacteriaMainFragment::class.java, Bundle())
            }
        }
    ...
    private fun restartFragment() {
        supportFragmentManager.commit {
            replace(R.id.containerFragment, BacteriaMainFragment::class.java, Bundle())
        }
    }
